...
# 【本番の叩き台・2026-07-23、注意目視後に確定】1段階目(age=0・色付き・白紙)で自己モデルが
...
# 注意：まだ実行しない。1段階目の動きのViewer目視で writhing GM らしさを確認してから、刻み・
...
# 注意：【2026-07-25 E_SYNERGY を 1→0 に変更】理由は「効かなかったから」ではない。
