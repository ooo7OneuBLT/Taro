# -*- coding: utf-8 -*-
"""【転送のみ】中身は `run/world/head_hold.py` へ移した（2026-09-13・段D）。
...
新しく書くコードは `from run.world.head_hold import ...` を直接使うこと。
...
from run.world.head_hold import *            # noqa: F401,F403,E402
import run.world.head_hold as _m             # noqa: E402
