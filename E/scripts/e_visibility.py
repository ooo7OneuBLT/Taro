# -*- coding: utf-8 -*-
"""【転送のみ】中身は `run/world/visibility.py` へ移した（2026-09-13・段D）。
...
新しく書くコードは `from run.world.visibility import ...` を直接使うこと。
...
from run.world.visibility import *            # noqa: F401,F403,E402
import run.world.visibility as _m             # noqa: E402
