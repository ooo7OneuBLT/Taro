# -*- coding: utf-8 -*-
"""【転送のみ】中身は `run/world/probes.py` へ移した（2026-09-13・段D）。
...
新しく書くコードは `from run.world.probes import ...` を直接使うこと。
...
from run.world.probes import *            # noqa: F401,F403,E402
import run.world.probes as _m             # noqa: E402
