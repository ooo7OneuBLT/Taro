...
注意：人間の実験は「その子の肩から手首までの長さ」に相当する距離に置く
...
def check_visible(env, pos):
    ...
    注意：【2026-07-28 に判明した穴】この探索は当初「視線からの角度」と
...
def main():
    ...
    with contextlib.redirect_stdout(buf):
        ...
        if os.environ.get("E_HEAD_HOLD", "1") == "1":
            ...
            # 注意：目標角を渡さないと「今の角度」で固定されるので、首の角度を変えても
    ...
    #   注意：近すぎ（<50%）は伸ばす動作にならない。人間の実験は腕をほぼ伸ばした距離
