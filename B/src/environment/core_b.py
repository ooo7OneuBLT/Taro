...
class TaroEnvironmentB:
    ...
    def __init__(self, config_path=None, run_name=None):
        ...
        self._milk_sweetness = 0.8             # 注意未検証：まんま/母乳の甘み値（後で感度確認）
    ...
    def _organ_activity(self, utter="", consolidated=0):
        ...
        try:
            out["hippocampus"] = float(max(0.0, min(1.0, consolidated / 50.0))) if consolidated > 0 else 0.0  # 注意正規化定数、未検証
        except Exception:
            pass
