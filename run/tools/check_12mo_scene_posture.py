# -*- coding: utf-8 -*-
"""12ヶ月シーン（座位_12ヶ月_2おもちゃ_F1-3c_1個提示_fovea_2026-08-23）の座位が
成立するかを確かめる（12ヶ月産出実験の準備②）。

依頼：12ヶ月での産出実験の準備（本走行なし）。
やること：6ヶ月版の関節角度を12ヶ月の体に流用して数十ステップ動かし、
...
使い方::
    ...
    .venv/Scripts/python.exe run/tools/check_12mo_scene_posture.py
"""
import os
import sys
